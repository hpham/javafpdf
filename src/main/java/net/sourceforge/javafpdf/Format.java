...
public class Format {
    ...
    /** ISO A0 */
    public static final Format A0 = new Format(841 * mm, 1189 * mm);
    ...
    /** ISO B0 */
    public static final Format B0 = new Format(1000 * mm, 1414 * mm);

    /** ISO B1 */
    public static final Format B1 = new Format(707 * mm, 1000 * mm);
    ...
    /** ISO C0 */
    public static final Format C0 = new Format(917 * mm, 1297 * mm);
